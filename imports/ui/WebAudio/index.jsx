...
fftSize:256,
fftBufferSize:128,
fftSizes:[32,64,128,256,512,1024,2048,8192,16384,32768],//,8192,16384,32768 - probs no point in having more, can add it for fun and testing
...
oscTriPhaseFreq(e) {
    ...
    let currentTime = this.au.currentTime;
		...
		this.setState({osc1Start:currentTime});
		this.setState({osc2Start:currentTime+phase});
		this.setState({osc3Start:currentTime+phase+phase});
	}
}
...
//this._scopeTimeData = scopeTimeData;
      ...
      this._scopeTimeData.datasets[3].borderColor = 'rgb( 133, 193, 233 )';
      this._scopeTimeData.datasets[3].backgroundColor = 'rgba( 133, 193, 233 , .05)';
        ...
        <Alert color="greay" isOpen={this.state.scopeTimeIsOpen}>
          <Navbar color="dark" dark expand="md">
            <NavbarBrand>
              ...
              <Button id="d" color={this.state.scopeTimeChD?"primary":"outline-primary"} onClick={(e) => this.scopeTimeCh(e)}>Math A - B</Button>|
